...
public class QuestionManagement extends JFrame {
	...
	public QuestionManagement() {
		...
		table.setModel(new DefaultTableModel(
			new Object[][] {
				{"What is JIT compiler?", "JIT improves the runtime performance of computer programs based on bytecode", "JIT is an application development framework", "JIT is an implementation of the Java Virtual Machine which executes Java programs", "None of the mentioned"},
				{"A top level class can be private or protected", "False", "True", null, null},
				{"Inheritance represents", "IS-A relationship", "HAS-A relationship", null, null},
				{"Try statements can be nested", "True", "False", null, null},
				...
				{"What is inheritance?", "  It is the process where one object acquires the properties of another.", null, null, null},
				{"What is the default value of char variable?", "'\\u0000' ", null, null, null},
				{"Constructor can be made final", "False", "True", null, null},
				{"What are Wrapper classes?", "These are classes that allow primitive types to be accessed as objects.", "These are classes that wraps functionality of an existing class.", "All of the mentioned.", "None of the mentioned."},
				{"What is the default value of byte variable?", "0", null, null, null},
				{"What invokes a thread's run() method?", "JVM invokes the thread's run() method when the thread is initially executed.", "Main application running the thread", "start() method of the thread class", "None of the mentioned"},
				{"How many classes can be defined in a single program?", "As many as you want", null, null, null},
				{"Static functions can be accessed using null reference", "False", "True", null, null},
				{"Which is the way in which a thread can enter the waiting state?", "Invoke its sleep() method", "invoke object's wait method", "Invoke its suspend() method", "All of the mentioned"},
				{"What is runtime polymorphism?", "Runtime polymorphism is a process in which a call to an overridden method is resolved at runtime rather than at compile-time.", "Runtime polymorphism is a process in which a call to an overloaded method is resolved at runtime rather than at compile-time", "All of the mentioned", "None of the mentioned"},
				{"What is the default value of short variable?", "0.0", null, null, null},
				{"What is Set Interface?", "Set is a collection of element which cannot contain duplicate elements.", "Set is a collection of element which contains elements along with their key", "Set is a collection of element which contains hashcode of elements", "Set is a collection of element which can contain duplicate elements"},
			},
			new String[] {
				"Question Title", "Correct Answer", "Answer 2", "Answer 3", "Answer 4"
			}
		));
		table.getColumnModel().getColumn(0).setPreferredWidth(633);
