...
public class updateQs extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					String AA2 = null;
					String AA3 = null;
					updateQs frame = new updateQs(clientx, QID, Q, CA, AA1, AA2, AA3);
	 ...
	 * Create the frame.
	 */
	public updateQs(ClientX clientx, String QID, String Q, String CA, String AA1, String AA2, String AA3) {
		...
		txtQ.setText(this.Q); // setting the default values of text areas into selected question's values
		txtCA.setText(this.CA);
		txtAA1.setText(this.AA1);
		txtAA2.setText(this.AA2);
		txtAA3.setText(this.AA3);
		...
		btnUpdQuestion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				updateQs.this.dispose();
			}
		});
		btnUpdQuestion.setForeground(Color.WHITE);
		btnUpdQuestion.setFont(new Font("Product Sans", Font.BOLD, 20));
		btnUpdQuestion.setBackground(new Color(51, 153, 51));
		btnUpdQuestion.setBounds(879, 524, 236, 35);
		contentPane.add(btnUpdQuestion);
